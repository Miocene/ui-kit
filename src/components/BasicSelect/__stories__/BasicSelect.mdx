...
| width?         | `full | default`                                  | `default`    | Cвойство определяет, какую ширину будет занимать компонент. `default` — ширина по размеру содержимого |
...
import { Table } from '@gpn-design/uikit/BasicSelect';
